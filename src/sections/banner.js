      ...
      <Container>
        <Box sx={styles.grid}>
          <Box as="form" sx={styles.domainCard}>
            <Heading className="text-center text-blue-500"> Legaltestation</Heading>
            <div style={{fontSize: '22px', marginRight: '0.5rem', fontWeight: 'bold'}} className="text-justify">
              <p>
              Welcome to Legaltestation—your trusted partner in resolving legal disputes through cutting-edge blockchain technology. With Legaltestation, you can verify, attest, and settle disputes with confidence, knowing that every transaction and agreement is immutably recorded on the blockchain, ensuring fairness and trustworthiness in every step. Powered by Sign Protocol.
              </p>
              <br />
            </div>
            <ConnectWallet />
